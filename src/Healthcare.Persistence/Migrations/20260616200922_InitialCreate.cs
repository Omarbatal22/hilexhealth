        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneNumber = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    BiologicalSex = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeverityScale = table.Column<int>(type: "integer", nullable: false),
                    AiTriageResult = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_file_metadata_appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_file_metadata_users_UploaderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_file_metadata_AppointmentId",
                table: "file_metadata",
                column: "AppointmentId");

            migrationBuilder.CreateIndex(
                name: "IX_file_metadata_UploaderId",
                table: "file_metadata",
                column: "UploaderId");

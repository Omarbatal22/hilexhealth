...
/// <inheritdoc />
public partial class AddAiTriageTables : Migration
{
    /// <inheritdoc />
    ...
    {
        migrationBuilder.DropTable(name: "TriagePredictions");
        migrationBuilder.DropTable(name: "TriageAssessments");
        migrationBuilder.DropTable(name: "ModelPerformanceMetrics");
        migrationBuilder.DropTable(name: "ModelVersions");
        migrationBuilder.DropTable(name: "TrainingDatasets");
        migrationBuilder.DropTable(name: "AiPredictionLogs");
    }
}

...
import { APP_NAV, PATIENT } from "@/lib/dashboard-data";
import { cn } from "@/lib/utils";

/** Persistent app sidebar (desktop) + slide-in drawer (mobile). */
      ...
      <div className="rounded-2xl border border-border-soft bg-surface/60 p-3">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="truncate text-xs text-ink-muted">{PATIENT.plan}</p>
          </div>
          <button
            type="button"
            aria-label="Log out"
